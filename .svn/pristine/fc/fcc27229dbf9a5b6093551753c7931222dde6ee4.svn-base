...
public class MazeBuilder implements Runnable {
	...
	public void run() {
		...
		try {
			...
			maze.newMaze(root, cells, dists, startx, starty);//EDITED -Sanity Testing for Project 3. startx and starty have been temporarily replaced with 0 and 0
		}
	...
	/**
	 * method for returning room count
	 */
	public int getRoomCt(){
		return rooms;
	}

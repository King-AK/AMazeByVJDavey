...
public class MapDrawer extends DefaultViewer {
	...
	@Override
	public void redraw(MazePanel gc, int state, int px, int py,
	...
	public void draw_map(MazePanel gc, int px, int py, int walk_step, int view_dx, int view_dy, boolean showMaze, boolean showSolution) {
		...
		for (int y = ymin; y <= ymax; y++)
			for (int x = xmin; x <= xmax; x++) {
				...
				gc.setColorWhiteorGray(seencells.hasWallOnTop(x, y)); //? Color.white : Color.gray);
				...
				gc.setColorWhiteorGray(seencells.hasWallOnLeft(x, y));// ? Color.white : Color.gray);
